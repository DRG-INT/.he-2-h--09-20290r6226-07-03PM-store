# Kernel Elődlők: A Rendszermag Elkülönülési Története
Verzió: 1.0-stable
Forrás: UNICAGD-Core Analízis
Státusz: HASZNÁLHATÓ

## 1. Mi volt a kernel elődje?
A kernel nem egy napon jött létre. Előbb voltak a szekvenciális felügyelők, a BIOS-központú rendszerek, a monitorok és a szigorúan felhasználói szintű rendszergazdák.

### 1.1 Monitor (1970-es évek eleje)
- A számítógép kezdeti felügyeleti rétege
- Nem volt önálló operációs rendszer
- Konzolos kezelőfelület, előkészítette az operációs rendszerek elválását

### 1.2 CP/M (Control Program/Monitor, 1974)
- Gary Kildall által készített
- 8 bites microprocesszorokra (Intel 8080, Zilog Z80)
- A kernel funkcionalitás: BDOS (Basic Disk Operating System), BIOS (Basic Input/Output System), CCP (Console Command Processor)
- Nem volt külön kernel a mai értelemben, de a BIOS/BDOS/CCP szétválasztása már a kernel elkülönülését jelezte

### 1.3 MP/M (Multi-Programming Monitor, 1979)
- Többfeladatos verziója a CP/M-nek
- A processzek szétválasztása, az I/O kezelés és a memóriakezelés elkülönülési folyamata
...
## 4. Miért lettek annyira stabilak, hogy szétfostuk tőle magunkat?
